    ...
    <div>
      ...
      {settlements.length === 0 ? (
        ...
        <div className="space-y-4">
          {settlements.map((s) => (
            <div key={s.id} className="bg-surface rounded-card border border-border-main p-6 shadow-soft flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-success/20 rounded-12 text-success"><CheckCircle size={24} /></div>
                <div>
