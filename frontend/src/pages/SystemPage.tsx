...
export default function SystemPage() {
 ...
 <div className="space-y-3">
              {allocations.map(a => (
 <div key={a.projectId} className="bg-elevated p-4 rounded-card border border-border-main flex justify-between items-center">
                  <div>
 ...
 <div key={id} className="bg-elevated p-4 rounded-card border border-border-main">
