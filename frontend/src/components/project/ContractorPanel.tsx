...
export const ContractorPanel: React.FC<Props> = ({ project, contractors }) => {
 ...
 <h3 className="text-h3 text-text-main mb-4">Assigned Contractors</h3>
 ...
 <div className="space-y-3">
          {assignedContractors.map(c => {
            ...
            return (
 <div key={c.id} className="p-4 bg-elevated rounded-card">
 <div className="flex items-center gap-3 mb-2">
 <div className="p-2 bg-surface rounded-8 text-text-muted"><User aria-hidden='true' size={16} /></div>
                  <div>
